      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            // Informations du relais (Flexible pour éviter overflow)
            Expanded(
              flex: 3,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    ack ? Icons.check_circle : Icons.radio_button_unchecked,
                    size: 14,
                    color: ack ? const Color(0xFF10B981) : const Color(0xFF94A3B8),
                  ),
                  const SizedBox(width: 4),
                  Text(
                    'ACK',
